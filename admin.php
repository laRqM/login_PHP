<?php
    ...
    } else { // SI EXISTE LA SESSION...
        if($_SESSION['rol'] != 1) { // SI LA SESSION EXISTE, VERIFICAMOS QUE LA SESSION TENGA EL ID 1, QUE ES EL ID PARA admin EN LA BASE DE DATOS.
            header('location: /index.php'); //SI ES DISTINTO DE 1, LO ENVIAMOS AL INDEX DEL SITIO.
        }
    } 
?>
<!doctype html>
    ...
    <body>
      ...
      <div class="container">
        <div class="text-center mt-5">
          ...
          <p>P&aacute;gina del administrador</p>
